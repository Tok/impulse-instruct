        ...
        "properties": {
            ...
            "fx": {
                ...
                "properties": {
                    ...
                    "spec_thresh":         { "type": "number", "minimum": 0.0, "maximum": 1.0, "description": "spectral-gate per-band threshold (linear amplitude). Bands whose envelope falls below get gated toward silence; bands above stay open. 0=transparent" },
