...
drive, eq, compressor, gate, vocoder, widen, tapesat, waveshaper, ringmod, lfo, tts, master.
...
`distortion_xy`, `autotune_xy`, `fx_pan_xy`, `gate_xy`, `vocoder_xy`, `widen_xy`.  Use pad-space when thinking
