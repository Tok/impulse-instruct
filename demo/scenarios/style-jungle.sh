...
ask "Style is jungle at 165 BPM. Chopped amen-style break: snare on 4 and 12, ghost snares on 7 and 15, kick on 0 and 10, fast hats with syncopation. Hihats pan slightly right, clap left, bass center."
...
ask "deep sub bass, sine-heavy, sparse pattern with gaps, low cutoff, slide between notes. 4 distinct scale pitches spread across BOTH halves of the bank"
